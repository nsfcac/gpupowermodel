...
def pltData ():
    ...
    # DGEMM
    tot_time, mean_pwr, arch, app, pltPath,mode,freqs = pltDVFSTimeIF (archP100, appStream, dataPathP100, pltPath,thresh)
    axs[0, 0].plot(freqs, tot_time,c='red',linestyle='dashed', marker='^', markersize=2)
    #axs[0, 0].axhline(y=0.5, color='orange', lw=2,linestyle='--',label="TDP")
    #axs[0,0].legend()
    # ax00 = axs[0,0].twinx()
    ...
    tot_time, mean_pwr, arch, app, pltPath,mode,freqs = pltPwrcapTimeIF (archP100, appStream, dataPathP100, pltPath,thresh)
    ...
    thresh = 46
    tot_time, mean_pwr, arch, app, pltPath,mode,freqs = pltDVFSTimeIF (archV100, appStream, dataPathV100, pltPath,thresh)
    ...
    thresh = 80
    tot_time, mean_pwr, arch, app, pltPath,mode,freqs = pltPwrcapTimeIF (archV100, appStream, dataPathV100, pltPath,thresh)
    ...
    plt.suptitle("BabelStream Runtime (s)",weight='bold', fontsize=12)
    #,
