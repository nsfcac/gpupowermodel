...
def pltData ():
    ...
    axs[1,0].set_xlabel("Core Frequency (MHz)",weight='bold',fontsize=12)

    axs[1,1].set_xlabel("Power Cap (W)",weight='bold',fontsize=12)
    ...
    plt.suptitle("BabelStream Energy Consumption (kJ)", weight='bold',fontsize=16)
    #,bbox_inches='tight'
    ...
    axs2[1,0].set_xlabel("Core Frequency (MHz)",weight='bold',fontsize=10)

    axs2[1,1].set_xlabel("Power Cap (W)",weight='bold',fontsize=10)
    ...
    plt.suptitle("DGEMM CUBLAS Energy Consumption (kJ)",weight='bold',fontsize=12)
    #,bbox_inches='tight'
